...
class ControlList(ControlBase):
    def __init__(self, *args, **kwargs):
        ...
        self._row_colors = kwargs.get('row_colors', [])
        self._row_header_color = kwargs.get('row_header_color', '')
    ...
    def select_entire_row(self):
        return self._select_entire_row
    ...
    @property
    def row_header_color(self):
        return self._row_header_color

    @row_header_color.setter
    def row_header_color(self, value):
        self._row_header_color = value
    ...
    def serialize(self):
        ...
        data.update({
            ...
            'row_header_color': self.row_header_color,
        })
        return data
